...
目前我在**富途牛牛**工作，是一名后端工程师，关注的方向是 **Golang** 和**云原生**上的基础设施，主要跟**可观测性**（**Observability**）相关，之前学习过 **Kubernetes** 的 Scheduler，另外对 **Redis** 也有少许的了解。如果您有兴趣一起来探讨技术上的问题，可以通过博客首页的邮箱联系到我。
